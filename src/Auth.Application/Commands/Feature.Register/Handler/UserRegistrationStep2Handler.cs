...
public class UserRegistrationStep2Handler : IRequestHandler<UserRegistrationStep2Command,OneOf<RegistrationTokenDto,Failure>>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IRegistrationRepository _registrationRepository;
    private readonly IJwtTokenGenerator _jwtTokenGenerator;

    public UserRegistrationStep2Handler(IUnitOfWork unitOfWork,IRegistrationRepository registrationRepository,IJwtTokenGenerator jwtTokenGenerator)
    {
    ...
    public async Task<OneOf<RegistrationTokenDto,Failure>> Handle(UserRegistrationStep2Command request, CancellationToken cancellationToken)
    {
        // ----------------------------------------------------------------------------------------------------
        // Begin Transaction 
        // ----------------------------------------------------------------------------------------------------
